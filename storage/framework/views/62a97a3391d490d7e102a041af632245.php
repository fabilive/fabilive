          ...
          <div class="col-lg-3 col-md-4">
             <div class="pro-details-sidebar-item mb-4">
                ...
                <h5><?php if( $productt->user_id  != 0): ?>
                  ...
                  <?php endif; ?>
                  <?php if($productt->user->is_verified == 1): ?>
                  <br>
                  <a class="verify-link" href="javascript:;" data-toggle="tooltip" data-placement="top" title=""
                    ...
                    <i class="fas fa-check-circle text-primary"></i> <?php echo e(__('Verified Seller')); ?>
                ...
                <p>
                    ...
                    <?php if($productt->product_location != null && isset($productt->cities)): ?>
...
<?php /**PATH C:\Users\Shilley Pc\fabilive\resources\views/partials/product-details/top.blade.php ENDPATH**/ ?>