							...
							<form id="geniusform" action="<?php echo e(route('admin-prod-store')); ?>" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-lg-8">
										...
										<!--							<ul class="list">-->
										<!--								<li>-->
										<!--<input name="stock_check" class="stock-check" type="hidden" id="size-check" value="1">-->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/product/create/physical.blade.php ENDPATH**/ ?>