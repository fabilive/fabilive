<?php if(request('success') && request('message')): ?>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 d-flex d-none d-lg-block">
                    <ul class="top-links d-flex ms-auto align-items-center justify-content-end">
                        ...
                        <?php else: ?>
                            <li><a class="border px-3 py-1"
                                    href="<?php echo e(route('vendor.register')); ?>"><?php echo e(__('Sell')); ?></a></li>
                        <?php endif; ?>
                        <?php if(!Auth::guard('rider')->check()): ?>
                            <li><a class="border px-3 py-1"
                                    href="<?php echo e(route('rider.register')); ?>"><?php echo e(__('Become a Delivery Agent')); ?></a></li>
                        <?php endif; ?>
                        <li>
                        ...
                        <li class="my-account-dropdown">
                            ...
                            <ul class="my-account-popup">
                                <?php if(Auth::guard('web')->check()): ?>
                                    <li><a href="<?php echo e(route('user-dashboard')); ?>"><span
                                                class="menu-item-text"><?php echo e('User
                                                                                            Panel'); ?></span></a>
                                    </li>
                                    <?php if(Auth::guard('web')->user()->IsVendor()): ?>
                                        <li><a href="<?php echo e(route('vendor.dashboard')); ?>"><span
                                                    class="menu-item-text"><?php echo e(__('Vendor
                                                                                                Panel')); ?></span></a>
                                        </li>
                                    <?php endif; ?>
                                    <li><a href="<?php echo e(route('user-profile')); ?>"><span
                                                class="menu-item-text"><?php echo e(__('Edit
                                                                                            Profile')); ?></span></a>
                                    </li>
                                    <li><a href="<?php echo e(route('user-logout')); ?>"><span
                                                class="menu-item-text"><?php echo e(__('Logout')); ?></span></a></li>
                                <?php elseif(Auth::guard('rider')->check()): ?>
                                    <li><a href="<?php echo e(route('rider-dashboard')); ?>"><span
                                                class="menu-item-text"><?php echo e('Delivery
                                                                                            Panel'); ?></span></a>
                                    </li>
                                    <li><a href="<?php echo e(route('rider-profile')); ?>"><span
                                                class="menu-item-text"><?php echo e(__('Edit
                                                                                            Profile')); ?></span></a>
                                    </li>
                                    <li><a href="<?php echo e(route('rider-logout')); ?>"><span
                                                class="menu-item-text"><?php echo e(__('Logout')); ?></span></a></li>
                                <?php else: ?>
                                    <li><a href="<?php echo e(route('user.login')); ?>"><span
                                                class="menu-item-text sign-in"><?php echo e(__('User
                                                                                            Login')); ?></span></a>
                                    </li>
                                    <li><a href="<?php echo e(route('rider.login')); ?>"><span
                                                class="menu-item-text sign-in"><?php echo e(__('Delivery Login')); ?></span></a>
                                    </li>
                                    <li><a href="<?php echo e(route('user.register')); ?>"><span
                                                class="menu-item-text join"><?php echo e(__('Join')); ?></span></a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="col-lg-8 d-lg-none mt-1">
                    <ul class="top-linksMob d-flex">
                        <div class="d-flex">
                            ...
                            <?php if(!Auth::guard('rider')->check()): ?>
                                <li><a class="border px-3 py-1"
                                        href="<?php echo e(route('rider.register')); ?>"><?php echo e(__('Become a Delivery Agent')); ?></a>
                                </li>
                            <?php endif; ?>
                        </div>
                        <li>
                            ...
                            <ul class="navbar-nav ms-md-5">
                                <li class="nav-item dropdown <?php echo e(request()->path() == '/' ? 'active' : ''); ?>">
                                    <a class="nav-link dropdown-toggle"
                                        href="<?php echo e(route('front.index')); ?>"><?php echo e(__('Home')); ?></a>
                                </li>
                                <?php if($ps->home == 1): ?>
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($category->subs->count() > 0): ?>
                                                    <li class="dropend">
                                                        <a class="dropdown-item d-flex justify-content-between align-items-center" href="<?php echo e(route('front.category', $category->slug)); ?>">
                                                                ...
                                                                <?php if($subcategory->childs && $subcategory->childs->count() > 0): ?>
                                                                    <li class="dropend">
                                                                        <a class="dropdown-item d-flex justify-content-between align-items-center"
                                                                            href="<?php echo e(route('front.category', [$category->slug, $subcategory->slug])); ?><?php echo e(!empty(request()->input('search')) ? '?search=' . request()->input('search') : ''); ?>">
                                                                        ...
                                                                        <ul class="sub-menu-dropdown list-unstyled">
                                                                            <?php $__currentLoopData = $subcategory->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <li>
                                                                                    <a class="dropdown-item" href="<?php echo e(route('front.category', [$category->slug, $subcategory->slug, $child->slug])); ?><?php echo e(!empty(request()->input('search')) ? '?search=' . request()->input('search') : ''); ?>">
                                                ...
                                                <?php else: ?>
                                                    <li><a class="dropdown-item" href="<?php echo e(route('front.category', $category->slug)); ?>"><?php echo e($category->name); ?></a></li>
                                                <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    </li>
                                ...
                                <?php if($ps->blog == 1): ?>
                                    <li class="nav-item dropdown <?php echo e(request()->path() == 'blog' ? 'active' : ''); ?>">
                                        <a class="nav-link dropdown-toggle"
                                            href="<?php echo e(route('front.blog')); ?>"><?php echo e(__('Blog')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($ps->faq == 1): ?>
                                    <li class="nav-item dropdown <?php echo e(request()->path() == 'faq' ? 'active' : ''); ?>">
                                        <a class="nav-link dropdown-toggle"
                                            href="<?php echo e(route('front.faq')); ?>"><?php echo e(__('FAQ')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if($ps->contact == 1): ?>
                                    <li class="nav-item <?php echo e(request()->path() == 'contact' ? 'active' : ''); ?>"><a
                                            class="nav-link"
                                            href="<?php echo e(route('front.contact')); ?>"><?php echo e(__('Contact')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    ...
                    <div class="margin-right-1 d-flex align-items-center justify-content-end h-100">
                                ...
                                <a href="<?php echo e(route('user-wishlists')); ?>" class="cart " title="View Wishlist">
                                    <div class="cart-icon"><i class="flaticon-like flat-mini mx-auto text-dark"></i>
                                        <span class="header-cart-count "
                                            id="wishlist-count"><?php echo e(Auth::guard('web')->user()->wishlistCount()); ?></span>
                                    </div>
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('user.login')); ?>" class="cart " title="View Wishlist">
                                    <div class="cart-icon"><i class="flaticon-like flat-mini mx-auto text-dark"></i>
                                        <span class="header-cart-count"
                                            id="wishlist-count"><?php echo e(0); ?></span></div>
                                </a>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="header-cart-1">
                            <a href="<?php echo e(route('front.cart')); ?>" class="cart has-cart-data" title="View Cart">
                                <div class="cart-icon"><i class="flaticon-shopping-cart flat-mini"></i> <span
                                        ...
                                        id="cart-count1"><?php echo e(Session::has('cart') ? count(Session::get('cart')->items) : '0'); ?></span>
                                </div>
                                <div class="cart-wrap">
                                    <div class="cart-text"><?php echo app('translator')->get('Cart'); ?></div>
                                    <span
                                        class="header-cart-count"><?php echo e(Session::has('cart') ? count(Session::get('cart')->items) : '0'); ?></span>
                                </div>
                            </a>
                        ...
                        <div class="header-user">
                            <a href="#" class="user-icon" id="userDropdownToggle" title="User Menu">
                                <div class="icon">
                                    ...
                                    <span class="notification-count"
                                        id="notificationCount"><?php echo e(session()->get('notifications', []) ? count(session()->get('notifications', [])) : 0); ?></span>
                            ...
                            <div class="dropdown-menu dropdown-custom" id="userDropdown">
                                ...
                                ?>
                                <ul>
                                    <?php $__currentLoopData = $sessionNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e(url('carts')); ?>"> <?php echo e($noti['message']); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                                            ...
                                            <div class="tab-pane fade show active woocommerce-Tabs-panel woocommerce-Tabs-panel--description"
                                                ...
                                                <div class="push-navbar">
                                                    <ul class="navbar-nav">
                                                        ...
                                                        <li class="nav-item ">
                                                            <a class="nav-link"
                                                                href="<?php echo e(route('front.category')); ?>"><?php echo e(__('PRODUCT')); ?></a>
                                                        </li>
                                                        <li class="nav-item dropdown">
                                                            <a class="nav-link dropdown-toggle"
                                                                href="#"><?php echo e(__('Pages')); ?></a>
                                                            <ul class="dropdown-menu">
                                                                <?php $__currentLoopData = $pages->where('header', '=', 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <li><a class="dropdown-item"
                                                                            href="<?php echo e(route('front.vendor', $data->slug)); ?>"><?php echo e($data->title); ?></a>
...
<!--==================== Header Section End ====================-->
<?php /**PATH C:\Users\Shilley Pc\fabilive\resources\views/partials/global/common-header.blade.php ENDPATH**/ ?>