...
<?php if(Auth::guard('admin')->user()->sectionCheck('orders')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('manage-country')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('earning')): ?>
...
<li>
    ...
    <ul class="collapse list-unstyled
        ...
        <li
            class="<?php if(request()->is('admin/attribute/*/manage') && request()->input('type')=='category'): ?> active <?php endif; ?>">
            <a href="<?php echo e(route('admin-cat-index')); ?>"><span><?php echo e(__('Main Category')); ?></span></a>
        </li>
        <li
            class="<?php if(request()->is('admin/attribute/*/manage') && request()->input('type')=='subcategory'): ?> active <?php endif; ?>">
            <a href="<?php echo e(route('admin-subcat-index')); ?>"><span><?php echo e(__('Sub Category')); ?></span></a>
        </li>
        <li
            class="<?php if(request()->is('admin/attribute/*/manage') && request()->input('type')=='childcategory'): ?> active <?php endif; ?>">
...
<?php if(Auth::guard('admin')->user()->sectionCheck('products')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('affilate_products')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('product_discussion')): ?>
...
<li>
    <a href="<?php echo e(route('admin-coupon-index')); ?>" class=" wave-effect"><i class="fas fa-percentage"></i><?php echo e(__('Set
        Coupons')); ?></a>
</li>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('customers')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('customer_deposits')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('vendors')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('vendor_subscriptions')): ?>
...
<li>
    ...
    <ul class="collapse list-unstyled" id="vendorSubs" data-parent="#accordion">
        ...
        <li>
            <a href="<?php echo e(route('admin-vendor-pendings','pending')); ?>"><span><?php echo e(__('Pending Subscriptions')); ?></span></a>
        </li>
    </ul>
</li>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('vendor_verifications')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('messages')): ?>
...
<?php if(Auth::guard('admin')->user()->sectionCheck('blog')): ?>
...
<li>
    <a href="<?php echo e(route('admin-staff-index')); ?>" class=" wave-effect"><i class="fas fa-user-secret"></i><?php echo e(__('Manage
        Staffs')); ?></a>
</li>

<?php endif; ?>

<?php if(Auth::guard('admin')->user()->sectionCheck('addons')): ?>
<li>
    <a href="<?php echo e(route('admin-addon-index')); ?>" class=" wave-effect"><i class="fas fa-list-alt"></i><?php echo e(__('Addon
        Manager')); ?></a>
</li>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/partials/admin-role/normal.blade.php ENDPATH**/ ?>