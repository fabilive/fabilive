                                 ...
                                 <div class="row mb-4">
                                    <div class="col-lg-6">
                                       <input name="name" type="text" class="input-field form-control border"
                                          placeholder="<?php echo e(__('User Name')); ?>" required="" value="<?php echo e($user->name); ?>">
                                    </div>
                                    <div class="col-lg-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/user/profile.blade.php ENDPATH**/ ?>