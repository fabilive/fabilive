...
<?php $__env->startSection('content'); ?>
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><?php echo e(__('Order Delivery')); ?></h4>
                    <ul class="links">
                        <li>
                        ...
                        <li>
                            <a href="<?php echo e(route('vendor.delivery.index')); ?>"><?php echo e(__('Order Delivery')); ?></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header d-block text-center">
                    <h4 class="modal-title d-inline-block"><?php echo e(__('Search Rider')); ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="riderSearchForm" action="<?php echo e(route('vendor-rider-search-submit')); ?>" method="POST"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-12 mt-3">
                                <select class="border pickup_select2" name="pickup_point_id" id="pickup_point_id" required>
                                    <option value="" selected><?php echo app('translator')->get('Select Pickup Point'); ?></option>
                                    <?php $__currentLoopData = App\Models\Pickup::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pickup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($pickup->id); ?>"><?php echo e($pickup->location); ?></option>
                        ...
                        <div class="text-right">
                            <button class="mybtn1" type="submit"><?php echo e(__('Save')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        (function($) {
            ...
            var table = $('#geniustable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo e(route('vendor-delivery-order-datatables')); ?>',
                columns: [{
                        data: 'order_number',
                        name: 'order_number'
                    },
            ...
            $(document).on('click', '.searchDeliveryRider', function() {
                ...
                $.get("<?php echo e(route('vendor.find.rider')); ?>", {
                    // city: city
                    order_id: order_id
                }, function(data) {
            ...
            function loadRiders() {
                $.get("<?php echo e(route('vendor.find.rider')); ?>", function(data) {
                    $('#redierList').html(data.riders);
                });
            }
...
<?php echo $__env->make('layouts.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/vendor/delivery/index.blade.php ENDPATH**/ ?>