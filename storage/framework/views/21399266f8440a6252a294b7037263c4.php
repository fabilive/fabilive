...
<div class="full-row bg-light overlay-dark py-5"
    ...
    <div class="container">
        <div class="row text-center text-white">
            <div class="col-12">
                <h3 class="mb-2 text-white"><?php echo e(__('Edit Service Area')); ?></h3>
            </div>
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="widget border-0 p-40 widget_categories bg-light account-info">
                            <h4 class="widget-title down-line mb-30"><?php echo e(__('Edit Service Area')); ?>
                            ...
                            <div class="edit-info-area">
                                <div class="body">
                                    <div class="edit-info-area-form">
                                        ...
                                        <form id="userform"
                                            action="<?php echo e(route('rider-service-area-update', $service_area->id)); ?>"
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    ...
                                                    <select class="service_area input-field form-control" name="service_area_id" id="service_area_id">
                                                        <?php $__currentLoopData = $service_areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($area->id); ?>" <?php echo e($service_area->service_area_id == $area->id ? 'selected' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/rider/edit_service.blade.php ENDPATH**/ ?>