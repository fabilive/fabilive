                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6 my-2">
                                       <input class="form-control" type="text" id="customer_whatsapp"
                                          placeholder="<?php echo e(__('WhatsApp Number (Optional)')); ?>"
                                          value="">
                                    </div>
                                    <div class="col-lg-6 my-2">
                                    ...
                                    <div class="col-lg-12">
                                       <div class="nav flex-column" role="tablist" aria-orientation="vertical">
                                          ...
                                          <a class="nav-link payment" href="javascript:;" data-show="yes"
                                             ...
                                             data-form="<?php echo e(route('front.payment.campay')); ?>"
                                             data-href="<?php echo e(route('front.load.payment', ['slug1' => 'campay', 'slug2' => 0])); ?>"
                                             aria-controls="v-pills-tab-campay" aria-selected="false">
                                             <div class="icon">
                                                <span class="radio"></span>
                                             </div>
                                             <p>
                                                <?php echo e(__('Campay (Mobile Money/Card)')); ?>

                                                <small>
                                                   <?php echo e(__('Fast & Secure local payment')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Shilley Pc\fabilive\resources\views/frontend/checkout.blade.php ENDPATH**/ ?>