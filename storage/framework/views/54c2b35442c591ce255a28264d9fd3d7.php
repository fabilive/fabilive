...
<?php $__env->startSection('content'); ?>
			...
			<div class="content-area">
				<div class="mr-breadcrumb">
					<div class="row">
						<div class="col-lg-12">
								<h4 class="heading"><?php echo e(__("License Product")); ?> <a class="add-btn" href="<?php echo e(route('vendor-prod-types')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__("Back")); ?></a></h4>
								<ul class="links">
									<li>
								...
								<li>
									...
									<li>
										<a href="<?php echo e(route('vendor-prod-create','license')); ?>"><?php echo e(__("License Product")); ?></a>
									</li>
								</ul>
						</div>
					</div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="text-editor">
                                                        <select name="product_city" class="form-control" required>
                                                            ...
                                                            <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($area->id); ?>"><?php echo e($area->city_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/vendor/product/create/license.blade.php ENDPATH**/ ?>