                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($product['size']): ?>
                                               <p>
                                                   <?php echo e(__('Size')); ?> : <?php echo e(str_replace('-',' ',$product['size'])); ?>

                                               </p>
                                               <?php endif; ?>
                                               <?php if($product['color']): ?>
                                                <p>
                                                    <?php echo e(__('Color')); ?> : <span style="margin-left: 40px; width: 20px; height: 0.2px; display: block; border: 10px solid <?php echo e($product['color'] == "" ? "white" : $product['color']); ?>;"></span>
                                                </p>
                                                <?php endif; ?>
                                                <p>
                                                    <?php echo e(__('Price')); ?> : <?php echo e(\PriceHelper::showOrderCurrencyPrice(($product['item_price'] * $order->currency_value),$order->currency_sign)); ?>

                                                </p>
                                               <p>
                                                <?php echo e(__('Qty')); ?> : <?php echo e($product['qty']); ?> <?php echo e($product['item']['measure']); ?>

                                               </p>
                                            </td>

                                            <td><?php echo e(\PriceHelper::showOrderCurrencyPrice(($product['price'] * $order->currency_value),$order->currency_sign)); ?> <small><?php echo e($product['discount'] == 0 ? '' : '('.$product['discount'].'% '.__('Off').')'); ?></small>
                                            </td>
                                            <?php
                                        ...
                                        <tr class="semi-border">
                                            ...
                                            <td><?php echo e(\PriceHelper::showOrderCurrencyPrice($subtotal,$order->currency_sign)); ?></td>
                                        ...
                                        <tr class="no-border">
                                            ...
                                            <td><?php echo e(\PriceHelper::showOrderCurrencyPrice($tax,$order->currency_sign)); ?></td>
                                        </tr>
                                        ...
                                        <tr class="final-border">
                                            ...
                                            <td><?php echo e(\PriceHelper::showOrderCurrencyPrice((($order->pay_amount + $order->wallet_price)  * $order->currency_value),$order->currency_sign)); ?></td>
                                        </tr>
...
<?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/pdf/order.blade.php ENDPATH**/ ?>