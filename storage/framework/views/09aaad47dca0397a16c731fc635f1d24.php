                  ...
                  <div class="col-lg-6 col-md-8 col-12 mx-auto">
                     <div class="registration-form border">
                        ...
                        <form id="forgotform" action="<?php echo e(route('user.forgot.submit')); ?>" method="POST">
                           ...
                           <p>
                              <label for="reg_email"><?php echo e(__('Email address')); ?><span class="required">*</span></label>
                              <input type="email" name="email" class="form-control border" placeholder="<?php echo e(__('Enter Email Address')); ?>" id="reg_email"  required="">
                           </p>
                           <p><?php echo e(__('A password will be sent to your email address.')); ?></p>
                           <p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/frontend/forget.blade.php ENDPATH**/ ?>