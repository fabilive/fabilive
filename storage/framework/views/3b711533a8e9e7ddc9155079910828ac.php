								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select droplinks <?php echo e($gs->is_comment == 1 ? 'drop-success' : 'drop-danger'); ?>">
	                                      <option data-val="1" value="<?php echo e(route('admin-gs-status',['is_comment',1])); ?>" <?php echo e($gs->is_comment == 1 ? 'selected' : ''); ?>><?php echo e(__('Activated')); ?></option>
	                                      <option data-val="0" value="<?php echo e(route('admin-gs-status',['is_comment',0])); ?>" <?php echo e($gs->is_comment == 0 ? 'selected' : ''); ?>><?php echo e(__('Deactivated')); ?></option>
	                                    </select>
	                                  </div>
								</div>
												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        ...
									                        <th width="20%"><?php echo e(__('Commenter')); ?></th>
									                        <th width="40%"><?php echo e(__('Comment')); ?></th>
...
<?php $__env->stopSection(); ?>   
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/comment/index.blade.php ENDPATH**/ ?>