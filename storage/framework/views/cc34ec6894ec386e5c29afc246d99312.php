 ...
 <div class="full-row bg-light overlay-dark py-5" style="background-image: url(<?php echo e($gs->breadcrumb_banner ? asset('assets/images/'.$gs->breadcrumb_banner):asset('assets/images/noimage.png')); ?>); background-position: center center; background-size: cover;">
    <div class="container">
        <div class="row text-center text-white">
            <div class="col-12">
                <h3 class="mb-2 text-white"><?php echo e(__('Messages')); ?></h3>
            </div>
            <div class="col-12">
                    ...
                    <div class="col-lg-12">
                        <div class="widget border-0 p-40 widget_categories bg-light account-info">
                            ...
                            <div class="header-area">
								...
								<h4 class="title">
									<?php echo e(__('Conversation with')); ?> <?php if($user->id == $conv->sent->id): ?>
                                    <?php echo e($conv->recieved->name); ?>

                                    <?php else: ?>
                                    <?php echo e($conv->sent->name); ?>

                                    <?php endif; ?> <a  class="mybtn1" href="<?php echo e(url()->previous()); ?>"> <i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a>
								</h4>
							</div>
                                ...
                                <div class="panel-primary">
                                    ...
                                    <div class="panel-footer">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="reciever" value="<?php echo e($conv->recieved->id); ?>">
                                              <?php else: ?>
                                                <input type="hidden" name="reciever" value="<?php echo e($conv->sent->id); ?>">
                                                <input type="hidden" name="recieved_user" value="<?php echo e($conv->recieved->id); ?>">
                                            <?php endif; ?>


                                                <textarea class="form-control" name="message" id="wrong-invoice" rows="5" style="resize: vertical;" required="" placeholder="<?php echo e(__('Message')); ?>"></textarea>
                                            </div>
                                    </div>
              ...
              <div class="col-md-12">
                <div class="contact-form">
                  <form id="emailreply1">
                    ...
                    <ul>
                      <li>
                        <input type="text" class="input-field form-control border mb-4" id="order" name="order_numkber" placeholder="<?php echo e(__('Order Number *')); ?>" required="">
                      </li>

                      <li>
                        <input type="text" class="input-field form-control border mb-4" id="subj1" name="subject" placeholder="<?php echo e(__('Subject *')); ?>" required="">
                      </li>
                      <li>
                        <textarea class="input-field textarea form-control border mb-4" name="message" id="msg1" placeholder="<?php echo e(__('Your Message *')); ?>" required=""></textarea>
                      </li>
                    </ul>
      ...
      <div class="modal-header d-block text-center">
          <h4 class="modal-title d-inline-block"><?php echo e(__('Confirm Delete ?')); ?></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  ...
                  <div class="modal-body">
              <p class="text-center"><?php echo e(__('You are about to delete this Dispute.')); ?></p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/user/message/create.blade.php ENDPATH**/ ?>