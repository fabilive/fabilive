...
Route::get('/run-setup', function() {
    ...
    return response()->json([
        ...
        'products_schema_details' => $products_desc,
            'categories_schema_details' => DB::select("DESCRIBE categories"),
...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:riders'], function () {
        ...
        Route::post('/riders/status/update', 'Admin\RiderController@statusUpdate')->name('admin-rider-status-update');
    ...
    Route::group(['middleware' => 'permissions:general_settings'], function () {
        ...
        //------------ ADMIN Delivery Fee Module ------------

        Route::get('/deliveryfee', 'Admin\DeliveryFeeController@index')->name('admin-deliveryfee-index');
        Route::get('/deliveryfee/create', 'Admin\DeliveryFeeController@create')->name('admin-deliveryfee-create');
        Route::post('/deliveryfee/create', 'Admin\DeliveryFeeController@store')->name('admin-deliveryfee-store');
        Route::get('/deliveryfee/edit/{id}', 'Admin\DeliveryFeeController@edit')->name('admin-deliveryfee-edit');
        Route::post('/deliveryfee/edit/{id}', 'Admin\DeliveryFeeController@update')->name('admin-deliveryfee-update');
        Route::delete('/deliveryfee/delete/{id}', 'Admin\DeliveryFeeController@destroy')->name('admin-deliveryfee-delete');

        //------------ ADMIN Delivery Fee Module ENDS------------ ------------

        //------------ ADMIN Distance Fee Module ------------

        Route::get('/distancefee', 'Admin\DistanceFeeController@index')->name('admin-distancefee-index');
        Route::get('/distancefee/create', 'Admin\DistanceFeeController@create')->name('admin-distancefee-create');
        Route::post('/distancefee/create', 'Admin\DistanceFeeController@store')->name('admin-distancefee-store');
        Route::get('/distancefee/edit/{id}', 'Admin\DistanceFeeController@edit')->name('admin-distancefee-edit');
        Route::post('/distancefee/edit/{id}', 'Admin\DistanceFeeController@update')->name('admin-distancefee-update');
        Route::delete('/distancefee/delete/{id}', 'Admin\DistanceFeeController@destroy')->name('admin-distancefee-delete');

        //------------ ADMIN Distance Fee Module ENDS------------ ------------

        //------------ ADMIN SERVICE AREA ------------

        Route::get('/service-areas/datatables', 'Admin\ServiceAreaController@datatables')->name('admin-servicearea-datatables');
        Route::get('/service-areas', 'Admin\ServiceAreaController@index')->name('admin-servicearea-index');
        Route::get('/service-areas/create', 'Admin\ServiceAreaController@create')->name('admin-servicearea-create');
        Route::post('/service-areas/create', 'Admin\ServiceAreaController@store')->name('admin-servicearea-store');
    ...
    Route::group(['middleware' => 'permissions:super'], function () {
        ...
        Route::get('/agreement/datatables', 'Admin\AgreeMentController@datatables')->name('admin-agreement-datatables');
        Route::get('/agreement', 'Admin\AgreeMentController@index')->name('admin-agreement-index');
        Route::get('/agreement/create', 'Admin\AgreeMentController@create')->name('admin-agreement-create');
        Route::post('/agreement/create', 'Admin\AgreeMentController@store')->name('admin-agreement-store');
        Route::get('/agreement/edit/{id}', 'Admin\AgreeMentController@edit')->name('admin-agreement-edit');
        Route::post('/agreement/edit/{id}', 'Admin\AgreeMentController@update')->name('admin-agreement-update');
        Route::delete('/agreement/delete/{id}', 'Admin\AgreeMentController@destroy')->name('admin-agreement-delete');
        // ------------ ADDON SECTION ----------------------
...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::prefix('user')->group(function () {
        ...
        // Hitpay
        // Route::post('/hitpay-submit', 'Payment\Subscription\HitpayController@store')->name('user.hitpay.submit');
        // Route::get('/hitpay-subscription/notify', 'Payment\Subscription\HitpayController@notify')->name('user.hitpay.notify');
        ...
        // Suleman code
        // Route::post('/deposit/store', 'User\DepositController@store')->name('user.deposit.store');
        // Route::get('/load/payment/{slug1}/{slug2}', 'User\DepositController@loadPayment')->name('user.load.payment');
        ...
        // Campay
        Route::post('/deposit/campay-submit', 'Payment\Deposit\CampayController@store')->name('deposit.campay.submit');
        Route::get('/deposit/campay/notify', 'Payment\Deposit\CampayController@notify')->name('deposit.campay.notify');

        // Hitpay
        Route::post('/deposit/hitpay-submit', 'Payment\Deposit\HitpayController@store')->name('deposit.hitpay.submit');
        Route::get('/deposit/hitpay/notify', 'Payment\Deposit\HitpayController@notify')->name('deposit.hitpay.notify');
...
Route::get('/', 'Front\FrontendController@index')->name('front.index');
    ...
    // Hitpay
    Route::post('/checkout/payment/hitpay-submit', 'Payment\Checkout\HitpayController@store')->name('front.payment.hitpay');
    Route::get('/payment/hitpay/notify', 'Payment\Checkout\HitpayController@notify')->name('front.hitpay.notify');

    //CamPay
    Route::post('/checkout/payment/campay-submit', 'Payment\Checkout\CampayController@store')->name('front.payment.campay');
    Route::get('/checkout/payment/campay/check/{order_number}', 'Payment\Checkout\CampayController@checkStatus')->name('front.campay.check');
    Route::get('/payment/campay/notify', 'Payment\Checkout\CampayController@notify')->name('front.campay.notify');
    ...
    // Route::post('/payment/Hitpay-submit', 'Api\Payment\HitpayController@store')->name('payment.Hitpay');
    // Route::get('/payment/Hitpay-notify', 'Api\Payment\HitpayController@notify')->name('payment.notify');
    ...
    // Route::post('/api/payment/hitpay-submit', 'Api\Payment\HitpayController@store')->name('api.hitpay.submit');
