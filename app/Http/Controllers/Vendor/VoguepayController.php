...
class VoguepayController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $user->is_vendor = 2;
                    ...
                    return redirect()->route('vendor-dashboard')->with('success', isset($user) && $user->is_vendor == 2 ? 'Vendor Account Activated Successfully' : 'Vendor Application Submitted Successfully. Please wait for admin approval.');
         }
}
