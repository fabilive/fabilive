...
class HitpayController extends SubscriptionBaseController
{
    ...
    public function __construct()
    {
        ...
        Config::set('services.hitpay.key', $paydata['key']);
        Config::set('services.hitpay.secret', $paydata['secret']);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $checkout_session = \Stripe\Checkout\Session::create([
                "mode" => "payment",
                "success_url" => route('user.hitpay.notify') . '?session_id={CHECKOUT_SESSION_ID}',
    ...
    public function notify(Request $request)
    {
        ...
        $user = $this->user;
        $stripe = new \Stripe\StripeClient(Config::get('services.hitpay.secret'));
