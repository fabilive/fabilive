...
{
    protected $fillable = ['requester_user_id', 'admin_id', 'rider_id', 'context', 'detected_role', 'status', 'assigned_agent_admin_id', 'started_at', 'assigned_at', 'ended_at', 'ended_by', 'rating_required'];
