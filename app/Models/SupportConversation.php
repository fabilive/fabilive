...
class SupportConversation extends Model
{
    ...
    public function assignedAgent() { return $this->belongsTo(Admin::class, "assigned_agent_admin_id"); }
    public function messages() { return $this->hasMany(SupportMessage::class, "conversation_id"); }
    public function rating() { return $this->hasOne(SupportRating::class, "conversation_id"); }
    public function events() { return $this->hasMany(SupportConversationEvent::class, "conversation_id"); }
}
