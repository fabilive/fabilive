...
<header class="ecommerce-header px-lg-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 d-flex d-none d-lg-block">
                    <ul class="top-links d-flex ms-auto align-items-center">
                        ...
                        <li><a class="border px-3 py-1" href="{{route('rider.register')}}">{{__('Become a Delivery Agent')}}</a></li>
                        @endif
                        
                        <li><div id="desktop_google_translate_element"></div></li>
                        ...
                        <li class="my-account-dropdown">
                            ...
                            <ul class="my-account-popup">
                                ...
                                <li><a href="{{ route('rider-dashboard') }}"><span class="menu-item-text">{{ ('Delivery
                                            Panel') }}</span></a></li>
                                    ...
                                    <ul class="dropdown-menu mega-dropdown-menu">
                                        <li class="mega-container">
                                            <div class="row row-cols-lg-4 row-cols-sm-2 row-cols-1">
                                                ...
                                                <div class="col">
                                                    <span class="d-inline-block px-3 font-600 text-uppercase text-secondary pb-2">{{
                                                        $category->name }}</span>
                                                    <!--<ul>-->
    ...
    <a href="#" class="user-icon" id="userDropdownToggle" title="User Menu">
        <div class="icon">
            ...
            <span class="notification-count" id="notificationCount">{{ session()->get('notifications', []) ? count(session()->get('notifications', [])) : 0 }}</span> <!-- Notification count added here -->
        </div> 
    </a> 
...
.dropdown-menu ul li a:hover {
    color: red !important; /* Text color will turn red on hover */
}
.user-icon {
    font-size: 20px;
    cursor: pointer;
...
<style>
    ...
    /* Hide the desktop widget on smaller screens */
