                            ...
                            <div class="pack-details">
                                ...
                                <form id="subscribe-form" class="pay-form"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="file" class="option" name="business_registration_certificate">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <h5 class="title pt-1">
                                                {{ __('Taxpayer Card copy or Taxpayer Identification Number (TIN) document copy [must]') }}
                                            </h5>
                                        </div>
                                        <div class="col-lg-8">
                                            <input type="file" class="option" name="tin">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="file" class="option" name="id_card_copy">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="file" class="option" name="passport_copy">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <h5 class="title pt-1">
                                                {{ __('Drivers License Copy') }}
                                            </h5>
                                        </div>
                                        <div class="col-lg-8">
                                            <input type="file" class="option" name="driver_license_copy">
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <h5 class="title pt-1">
                                                {{ __('Residence Permit for foreigners [must]') }}
                                            </h5>
                                        </div>
                                        <div class="col-lg-8">
                                            <input type="file" class="option" name="residence_permit">
                                        </div>
                                    </div>
                                    <br>
