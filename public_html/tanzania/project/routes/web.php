...
Route::group(['middleware' => 'maintenance'], function () {
    ...
    Route::prefix('user')->group(function () {
        ...
        // PesaPal
        Route::post('/deposit/pesapal-submit', 'Payment\Deposit\PesapalController@store')->name('deposit.pesapal.submit');
        Route::get('/deposit/pesapal/notify', 'Payment\Deposit\PesapalController@notify')->name('deposit.pesapal.notify');
    ...
    // Pesapal
    Route::post('/checkout/payment/pesapal-submit', 'Payment\Checkout\PesapalPaymentController@store')->name('front.payment.pesapal');
    Route::get('/payment/pesapal/notify', 'Payment\Checkout\PesapalPaymentController@notify')->name('front.pesapal.notify');
