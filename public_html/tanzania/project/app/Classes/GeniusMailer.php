...
class GeniusMailer
{
    ...
    //Testing method craeted by awais
    // public function sendCustomMailll(array $mailData)
    // {
    //     try {
    //         if (!$this->mail) {
    //             throw new Exception("PHPMailer instance is not initialized.");
    //         }
    
    //         $this->mail->isSMTP();
    //         $this->mail->Host = 'mail.fabilive.top';
    //         $this->mail->SMTPAuth = true;
    //         $this->mail->Username = 'system@fabilive.top';
    //         $this->mail->Password = 'u234Un9870@me123@';
    //         $this->mail->SMTPSecure = 'ssl'; // Use 'tls' for port 587
    //         $this->mail->Port = 465;
    
    //         // Set Sender
    //         $this->mail->setFrom('system@fabilive.top', 'Fabilive');
