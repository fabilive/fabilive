...
{
    protected $fillable = ['name', 'photo', 'zip', 'city_id', 'state_id', 'country','country_id', 'address', 'phone',
     'fax', 'email', 'password', 'affilate_code','reff', 'verification_link', 'shop_name', 'owner_name',
     'shop_number', 'shop_address', 'reg_number', 'shop_message', 'is_vendor', 'shop_details',
     'shop_image', 'shipping_cost', 'date', 'mail_sent', 'email_verified','current_balance', 'email_token', 'reward',
      'national_id_front_image', 'national_id_back_image','submerchant_agreement', 'license_image','business_registration_certificate',
      'tin','id_card_copy','passport_copy','driver_license_copy','residence_permit'];
    protected $hidden = [
