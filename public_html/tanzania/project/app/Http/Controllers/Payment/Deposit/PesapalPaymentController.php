...
class PesapalPaymentController extends DepositBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if (!in_array($curr->id, $supported_currency)) {
            return redirect()->back()->with('unsuccess', __('Invalid Currency For Pesapal Payment.'));
        }
        ...
        try {
            ...
            if (isset($response['link'])) {
                ...
                //return redirect()->route('deposit.pesapal.notify');
