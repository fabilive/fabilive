...
<html lang="en">
   <head>
	  ...
	  <title><?php echo e($gs->title); ?>-Deposit</title>
                               ...
                               <div class="col-lg-12 mt-3">
                                  <div class="bottom-area">
                                    <input type="hidden" value="<?php echo e($deposit->amount * $curr->value); ?>" id="grandTotal">
                                     <button type="submit" id="final-btn" class="mybtn1"><?php echo e(__('Deposit')); ?></button>
                                  </div>
                               </div>
                            </div>
                         </div>
...
<?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/user/deposit/payment.blade.php ENDPATH**/ ?>