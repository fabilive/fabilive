    ...
    <div id="sidebar" class="widget-title-bordered-full">
        ...
        <div id="woocommerce_product_categories-4" class="widget woocommerce widget_product_categories widget-toggle">
            ...
            <ul class="product-categories">
                <?php $__currentLoopData = App\Models\Category::where('status',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="product-style-2 owl-carousel owl-nav-hover-primary nav-top-right single-carousel dot-disable product-list e-bg-white">
                    ...
                    <?php $__currentLoopData = array_chunk($latest_products->toArray(),3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="product type-product">
                                    <div class="product-wrapper">
                                        <div class="product-image">
                                            <a href="<?php echo e(route('front.product', $prod['slug'])); ?>" class="woocommerce-LoopProduct-link"><img src="<?php echo e($prod['thumbnail'] ? asset('assets/images/thumbnails/'.$prod['thumbnail'] ):asset('assets/images/noimage.png')); ?>" alt="Product Image"></a>
                                        ...
                                        <div class="product-info">
                                            <h3 class="product-title"><a href="<?php echo e(route('front.product', $prod['slug'])); ?>"><?php echo e(App\Models\Product::whereId($prod['id'])->first()->showName()); ?></a></h3>
                                            <div class="product-price">
                                                <div class="price">
                                                    <ins><?php echo e(App\Models\Product::whereId($prod['id'])->first()->showPrice()); ?></ins>
                                                    <del><?php echo e(App\Models\Product::whereId($prod['id'])->first()->showPreviousPrice()); ?></del>
                                                </div>
                                                <div class="on-sale"><span><?php echo e(round(App\Models\Product::whereId($prod['id'])->first()->offPercentage())); ?></span><span>% off</span></div>
                                            </div>
                                            <div class="shipping-feed-back">
                                                <div class="star-rating">
                                                    <div class="rating-wrap">
                                                        <p><i class="fas fa-star"></i><span> <?php echo e(App\Models\Rating::ratings($prod['id'])); ?></span></p>
                                                    </div>
                                                    <div class="rating-counts-wrap">
                                                        <p>(<?php echo e(App\Models\Rating::ratingCount($prod['id'])); ?>)</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/partials/catalog/vendor-catalog.blade.php ENDPATH**/ ?>