...
<?php $__env->startSection('content'); ?>
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
								  <div class="col-lg-12">
									  <h4 class="heading"><?php echo e(__('Add New Link')); ?> <a class="add-btn" href="<?php echo e(route('vendor-sociallink-index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
									  <ul class="links">
										<li>
										...
										<li>
										  <a href="<?php echo e(route('vendor-sociallink-index')); ?>"><?php echo e(__('Social Links')); ?></a>
										</li>
										<li>
										  <a href="<?php echo e(route('vendor-sociallink-create')); ?>"><?php echo e(__('Add')); ?></a>
										</li>
									  </ul>
								  </div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="geniusform" action="<?php echo e(route('vendor-sociallink-create')); ?>" method="POST" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/vendor/sociallink/create.blade.php ENDPATH**/ ?>