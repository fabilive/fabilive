		...
		<div class="row">
         ...
         <!--                           </div>-->
                                                                ...
                                                                <div class="col-lg-5">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            <?php if(is_array($selectedAttrs) && array_key_exists($inName, $selectedAttrs)): ?>
                                                                        ...
                                                                        <div class="col-10">
                                                                            <div class="price-container">
                                                                                ...
                                                                                <input type="text" class="input-field price-input"
                                                                                    ...
                                                                                    value="<?php echo e(!empty($selectedAttrs[$inName]['prices'][$i]) && $checked == 1 ? round($selectedAttrs[$inName]['prices'][$i] * $sign->value, 2) : ''); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div id="subcatAttributes">
                                        <?php
                                            $subAttributes = $data->subcategory->attributes ?? '';
                                        ?>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <?php $__currentLoopData = $subAttribute->attribute_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-5">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" id="<?php echo e($inName); ?><?php echo e($option->id); ?>" name="<?php echo e($inName); ?>[]" value="<?php echo e($option->name); ?>" class="custom-control-input attr-checkbox"
                                                                            <?php if(is_array($selectedAttrs) && array_key_exists($inName, $selectedAttrs) && in_array($option->name, $selectedAttrs[$inName]['values'] ?? [])): ?>
                                                                                checked
                                                                                <?php $checked = 1; ?>
                                                                            <?php endif; ?>>
                                                                        <label class="custom-control-label" for="<?php echo e($inName); ?><?php echo e($option->id); ?>"><?php echo e($option->name); ?></label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-7 <?php echo e($subAttribute->price_status == 0 ? 'd-none' : ''); ?>">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-10">
                                                                            <div class="price-container">
                                                                                <span class="price-curr"><?php echo e($sign->sign); ?></span>
                                                                                <input type="text" class="input-field price-input" id="<?php echo e($inName); ?><?php echo e($option->id); ?>_price" data-name="<?php echo e($inName); ?>_price[]" placeholder="0.00 (Additional Price)" value="<?php echo e($checked ? round($selectedAttrs[$inName]['prices'][$i] * $sign->value, 2) : ''); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div id="childcatAttributes">
                                        <?php
                                            $childAttributes = $data->childcategory->attributes ?? '';
                                        ?>
                                        ...
                                        <?php if(!empty($childAttributes)): ?>
                                            <?php $__currentLoopData = $childAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childAttribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <?php $i = 0; ?>
                                                        <?php $__currentLoopData = $childAttribute->attribute_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                    ...
                                    <!-- iiss mien jo commented code tha woh meiny partition E mein fabilive folder mien rakha ha  -->
                                    <!-- Comments Ends Here -->
									...
									<div class="">
										<div class="row">
											<div class="col-lg-12">
												<div class="left-area">
													<h4 class="heading"><?php echo e(__('Cross Showing Product By Current
														Category')); ?>*</h4>
												</div>
											</div>
											<div class="col-lg-12">
												...
												<select name="cross_products[]" multiple id="cross_product"
													...
													<option value="<?php echo e($item->id); ?>" <?php echo e(in_array($item->
														id,$cross_product_id) ? 'selected' : ''); ?> ><?php echo e($item->name); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/product/edit/physical.blade.php ENDPATH**/ ?>