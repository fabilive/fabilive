...
<div class="full-row bg-light overlay-dark py-5" style="background-image: url(<?php echo e($gs->breadcrumb_banner ? asset('assets/images/'.$gs->breadcrumb_banner):asset('assets/images/noimage.png')); ?>); background-position: center center; background-size: cover;">
    <div class="container">
        <div class="row text-center text-white">
            <div class="col-12">
                <h3 class="mb-2 text-white"><?php echo e(__('Products')); ?></h3>
            </div>
            <div class="col-12">
...
<div class="full-row">
    <div class="container">
        <div class="row">
            <?php if ($__env->exists('partials.catalog.vendor-catalog')) echo $__env->make('partials.catalog.vendor-catalog', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="col-lg-9">
                ...
                <?php if ($__env->exists('partials.product.vendor-product-different-view')) echo $__env->make('partials.product.vendor-product-different-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <?php echo $__env->make('frontend.pagination.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/frontend/vendor.blade.php ENDPATH**/ ?>