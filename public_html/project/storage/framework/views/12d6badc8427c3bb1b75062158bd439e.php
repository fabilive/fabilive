...
<div class="full-row bg-light overlay-dark py-5"
    ...
    <div class="container">
        <div class="row text-center text-white">
            <div class="col-12">
                <h3 class="mb-2 text-white"><?php echo e(__('Chat With Delivery Boy')); ?></h3>
            </div>
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 d-inline-flex bg-transparent p-0">
                        <li class="breadcrumb-item"><a href="<?php echo e(route('user-dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
                        <li class="breadcrumb-item active"><?php echo e(__('Chat With Delivery Boy')); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-xl-8">
                <div class="row g-0 border rounded shadow-sm" style="height:600px;">
                        ...
                        <ul class="list-group list-group-flush" id="chat-list">
                            <?php $__empty_1 = true; $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="list-group-item list-group-item-action chat-item
                                    ...
                                    <strong class="p-1"><?php echo e($chat->rider->name ?? 'Unknown Rider'); ?></strong>
                                </li>
                    ...
                    <div class="col-xl-9 col-lg-8 d-flex flex-column bg-white">
                        <div class="p-3 border-bottom">
                            <h6 class="mb-0" id="chat-header"><?php echo e(__('Select a chat')); ?></h6>
                        </div>
                        ...
                        <form id="chat-form" class="d-flex p-3 border-top bg-light">
                            ...
                            <button type="submit" class="btn btn-primary rounded-pill px-4"><?php echo e(__('Send')); ?></button>
                        </form>
                    </div>
...
<script>
    ...
    item.addEventListener('click', function () {
        ...
        // Fetch messages
        fetch("<?php echo e(route('user-chat-fetch')); ?>", {
            method: "POST",
            headers: {
    ...
    function subscribePusherChannel(chatId) {
        ...
        const pusher = new Pusher("<?php echo e(env('PUSHER_APP_KEY')); ?>", { cluster: "mt1", forceTLS: true });
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/user/messagedelivery/index.blade.php ENDPATH**/ ?>