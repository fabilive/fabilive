    ...
    <div class="row row-cards-one">
        ...
        <div class="col-md-12 col-lg-6 col-xl-4">
            <div class="mycard bg6">
                ...
                <div class="left">
                    <h5 class="title"><?php echo e(__('Total Commission!')); ?></h5>
                    <span class="number"><?php echo e(number_format($total_commission, 2)); ?> <?php echo e($default_currency->sign); ?></span>
                    <a href="<?php echo e(route('admin-commission-income')); ?>" class="link"><?php echo e(__('View All')); ?></a>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>