...
<input type="hidden" id="headerdata" value="<?php echo e(__(" RIDER")); ?>">
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
				<h4 class="heading"><?php echo e(__("Riders")); ?></h4>
				<ul class="links">
					<li>
						...
						<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th><?php echo e(__("Total Delivery")); ?></th>
...
<script type="text/javascript">
	(function($) {
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-rider-datatables')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
...
<script>
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo e(route('admin-rider-status-update')); ?>',
        data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/rider/index.blade.php ENDPATH**/ ?>