                        ...
                        <form id="geniusformdata" action="<?php echo e(route('admin-cat-create')); ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              <div class="col-lg-4">
                                <div class="left-area">
                                  <h4 class="heading"><?php echo e(__('Set Photo')); ?> *</h4>
                                </div>
                              </div>
                              <div class="col-lg-7">
                                <div class="img-upload ">
...
<?php echo $__env->make('layouts.load', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/category/create.blade.php ENDPATH**/ ?>