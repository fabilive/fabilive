...
<li>
    ...
    <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
        ...
        <!-- Delivery Fee Module -->
        <li>
            <a href="<?php echo e(route('admin-deliveryfee-index')); ?>"><span><?php echo e(__('Delivery Fee Module')); ?></span></a>
        </li>
        <!-- Distance Fee Module -->
        <li>
            <a href="<?php echo e(route('admin-distancefee-index')); ?>"><span><?php echo e(__('Distance Fee Module')); ?></span></a>
        </li>

        <li>
            <a href="<?php echo e(route('admin-servicearea-index')); ?>"><span><?php echo e(__('Service Area')); ?></span></a>
        </li>
        <li>
...
<li>
    <a href="<?php echo e(route('admin-agreement-index')); ?>" class=" wave-effect"><i class="fas fa-user-tag"></i><?php echo e(__('Manage Agreements')); ?></a>
</li>
...
</li><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/partials/admin-role/super.blade.php ENDPATH**/ ?>