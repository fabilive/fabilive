...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-8 order-last order-lg-first">
					<form action="" method="POST" class="checkoutform">
												...
												<div class="col-lg-12">
													<div class="nav flex-column" role="tablist"
														...
														<a class="nav-link payment " data-val=""
															data-show="<?php echo e($gt->showForm()); ?>"
															data-form="<?php echo e($gt->showApiCheckoutLink()); ?>"
														...
														<a class="nav-link payment" href="javascript:;" data-show="no"
                                                            ...
                                                            data-form="<?php echo e(route('api.wallet.submit')); ?>"
                                                            aria-controls="v-pills-tab-wallet"
                                                            aria-selected="false">
                                                            <div class="icon">
                                                                <span class="radio"></span>
                                                            </div>
												...
												<div class="col-lg-12">
													<div class="pay-area d-none">
														<div class="tab-content" id="v-pills-tabContent">
															...
															<?php if($gt->type == 'manual'): ?>
															<?php if($order->dp == 0): ?>
															<div class="tab-pane fade" id="v-pills-tab-wallet"
                                                                role="tabpanel"
                                                                aria-labelledby="v-pills-tab-wallet-tab">
                                                            </div>
															<?php endif; ?>
															<?php else: ?>
										...
										<div class="row">
											<div class="col-lg-12 mt-3">
												<div class="bottom-area">
													<input type="hidden"
														value="<?php echo e($order->pay_amount * $order->currency_value); ?>"
														id="grandTotal">
													<button type="submit" id="final-btn"
														class="mybtn1"><?php echo e(__('Checkout')); ?></button>
												</div>
											</div>
										</div>
									</div>
						...
						<input type="hidden" id="preamount" value="<?php echo e($order->pay_amount * $order->currency_value); ?>">
						<input type="hidden" name="order_number" value="<?php echo e($order->order_number); ?>">
						<input type="hidden" name="email" value="<?php echo e($order->customer_email); ?>">
					...
					<div class="right-area">
						<div class="order-box">
							...
							<div class="total-price">
								<p>
									<?php echo app('translator')->get('Total Order Amount'); ?>
								</p>
								<p>
									<?php if($gs->currency_format == 0): ?>
									<span id="total-cost"><?php echo e($order->currency_sign); ?><span class="total_price"> <?php echo e($order->pay_amount * $order->currency_value); ?></span></span>
									<?php else: ?>
									<span id="total-cost"> <span class="total_price"> <?php echo e($order->pay_amount *
											$order->currency_value); ?></span><?php echo e($order->currency_sign); ?></span>
									<?php endif; ?>
								</p>
							</div>
	...
	<script type="text/javascript">
        ...
        // Generate txnid only if Campay or similar is selected
        var selectedMethod = $('a.payment.active').data('val');
        if (selectedMethod === 'campay') {
            const txnidField = $('#txnid');
            if (txnidField.val() === '') {
                txnidField.val('TXN-' + Date.now() + '-' + Math.floor(Math.random() * 100000));
            }
        }
    });
	...
	</script><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/payment/checkout.blade.php ENDPATH**/ ?>