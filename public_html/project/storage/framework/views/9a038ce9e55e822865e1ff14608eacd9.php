                            ...
                            <div class="widget border-0 p-40 widget_categories bg-light account-info">
                                <div class="d-flex align-items-center justify-content-between my-3 ">
                                    ...
                                    <a class="mybtn1" href="<?php echo e(route('user-wwt-index')); ?>"> <i class="fas fa-arrow-left"></i>
                                        ...
                                        <?php echo e(App\Models\Product::vendorConvertPrice(Auth::user()->balance)); ?></h5>
                                </div>
                                <hr>
                                <div class="gocover"
                                    style="background: url(<?php echo e(asset('assets/images/' . $gs->loader)); ?>) no-repeat scroll center center rgba(45, 45, 45, 0.5);">
                                </div>
                                <form id="userform" class="form-horizontal" action="<?php echo e(route('user-wwt-store')); ?>"
                                method="POST">
                                    ...
                                    <div class="form-group mt-4 mb-4">
                                        <label class="control-label col-sm-12 mb-2"
                                            for="name"><?php echo e(__('Withdraw Amount')); ?> *
                                        </label>
                                        <div class="col-sm-12">
                                            <input name="amount" placeholder="<?php echo e(__('Withdraw Amount')); ?>"
                                    ...
                                    <div class="mb-3" id="paypal" style="display: none;">
                                        <div class="form-group">
                                            <label class="control-label col-sm-12"
                                                for="name"><?php echo e(__('Enter Account Email')); ?> *
                                            </label>
                                            <div class="col-sm-12">
                                    ...
                                    <div id="campay" class="mb-3" style="display: none;">
                                        <div class="item form-group mb-3 s">
                                            <label class="control-label col-sm-12"
                                                for="network"><?php echo e(__('Select Network')); ?> *</label>
                                            <div class="col-sm-12">
                                        ...
                                        <div class="item form-group mb-3 s">
                                            <label class="control-label col-sm-12"
                                                for="campay_acc_no"><?php echo e(__('Account Number')); ?> *</label>
                                            <div class="col-sm-12">
                                                <input name="campay_acc_no" placeholder="<?php echo e(__('Enter Account Number')); ?>"
                                                    class="form-control border" type="text">
                                            </div>
                                        </div>
                                        <div class="item form-group mb-3 s">
                                            <label class="control-label col-sm-12"
                                                for="campay_acc_name"><?php echo e(__('Account Name')); ?> *</label>
                                            <div class="col-sm-12">
                                                <input name="campay_acc_name" placeholder="<?php echo e(__('Enter Account Name')); ?>"
                                                    class="form-control border" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="bank" style="display: none;">
                                        <div class="form-group mb-3 s">
                                            <label class="control-label col-sm-12"
                                                for="name"><?php echo e(__('Enter IBAN/Account No')); ?>

                                                *
                                            </label>
                                            <div class="col-sm-12">
                                                <input name="iban" value=""
                                                    placeholder="<?php echo e(__('Enter IBAN/Account No')); ?>" class="form-control border"
                                                    type="text">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 s">
                                            <label class="control-label col-sm-12"
                                                for="name"><?php echo e(__('Enter Account Name')); ?> *
                                            </label>
                                            <div class="col-sm-12">
                                                <input name="acc_name" value=""
                                                    placeholder="<?php echo e(__('Enter Account Name')); ?>" class="form-control border"
                                                    type="text">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 s">
                                            <label class="control-label col-sm-12"
                                                for="name"><?php echo e(__('Enter Address')); ?> *
                                            </label>
                                            <div class="col-sm-12">
                                                <input name="address" value=""
                                                    placeholder="<?php echo e(__('Enter Address')); ?>" class="form-control border"
                                                    type="text">
                                            </div>
                                        </div>
                                        <div class="form-group mb-3 s">
                                            <label class="control-label col-sm-12"
                                                for="name"><?php echo e(__('Enter Swift Code')); ?> *
                                            </label>
                                            <div class="col-sm-12">
                                                <input name="swift" value=""
                                                    placeholder="<?php echo e(__('Enter Swift Code')); ?>" class="form-control border"
                                                    type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3 s">
                                        <label class="control-label col-sm-12 mb-2"
                                            for="name"><?php echo e(__('Additional Reference(Optional)')); ?> *
                                        </label>
                                        <div class="col-sm-12">
        ...
        $('#userform').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo e(route('user-wwt-index')); ?>";
                    }, 1500);
                },
                error: function (xhr) {
                    $('.gocover').hide();
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/user/withdraw/withdraw.blade.php ENDPATH**/ ?>