                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="widget border-0 p-40 widget_categories bg-light account-info">
                            ...
                            <h4 class="widget-title down-line mb-30"><?php echo e(__('Reward')); ?>

                                <a class="mybtn1" href="<?php echo e(route('user-reward-convernt')); ?>"> <i class="fas fa-plus"></i> <?php echo e(__('Convert Point')); ?></a>
                            </h4>
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="table" cellspacing="0" width="100%">
                                        ...
                                        <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td data-label="<?php echo e(__('Reward')); ?>">
                                                    <div>
                                                        <?php echo e($data->reward_point); ?>

                                                    </div>
                                                </td>
                                                <td data-label="<?php echo e(__('Amount')); ?>">
                                                    <div>
                                                        $<?php echo e($data->reward_dolar); ?>

                                                    </div>
                                                </td>
                                                <td data-label="<?php echo e(__('Created at')); ?>">
                                                    <div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/user/reward/index.blade.php ENDPATH**/ ?>