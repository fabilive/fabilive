...
<?php $__env->startSection('content'); ?>
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading"><?php echo e(__('Add New Post')); ?> <a class="add-btn" href="<?php echo e(route('admin-blog-index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="<?php echo e(route('admin-blog-create')); ?>"><?php echo e(__('Add New Post')); ?></a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="<?php echo e(route('admin-blog-create')); ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              <div class="text-editor">
                                <textarea class="input-field" name="meta_description" placeholder="<?php echo e(__('Meta Description')); ?>"></textarea> 
                              </div>
                            </div>
                          </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/blog/post/create.blade.php ENDPATH**/ ?>