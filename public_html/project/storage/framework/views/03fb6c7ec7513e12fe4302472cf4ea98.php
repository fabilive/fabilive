               ...
               <div class="col-lg-12">
                  <div class="widget border-0 p-40 widget_categories bg-light account-info">
                     <h4 class="widget-title down-line mb-30"><?php echo e(__('My Withdraws')); ?>
                        ...
                        <a class="mybtn1" href="<?php echo e(route('rider-wwt-create')); ?>"> <i class="fas fa-plus"></i> <?php echo e(__('Withdraw Now')); ?></a>
                     </h4>
                        ...
                        <div class="table-responsive">
                           <table id="example" class="table" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td data-label="<?php echo e(__('Withdraw Date')); ?>">
                                       <div>
                                          <?php echo e(date('d-M-Y',strtotime($withdraw->created_at))); ?>

                                       </div>
                                    </td>
                                    <td data-label="<?php echo e(__('Method')); ?>">
                                       <div>
                                          <?php echo e($withdraw->method); ?>
                                    ...
                                    <td data-label="<?php echo e(__('Amount')); ?>">
                                       <div>
                                          <?php echo e($sign->sign); ?><?php echo e(round($withdraw->amount * $sign->value , 2)); ?>

                                       </div>
                                    </td>
                                    <td data-label="<?php echo e(__('Status')); ?>">
                                       <div>
                                          <?php echo e(ucfirst($withdraw->status)); ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/rider/withdraw/index.blade.php ENDPATH**/ ?>