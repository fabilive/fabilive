			...
			<div class="row">
				<div class="col-lg-12">
						...
						<ul class="links">
							...
							<li>
								<a href="javascript:;"><?php echo e(__("License Product")); ?></a>
							</li>
							<li>
							...
							<div class="col-lg-12">
								<div class="product-description">
												...
												<div class="featured-keyword-area">
													...
													<div class="feature-tag-top-filds" id="license-section">
														<?php if(!empty($data->license)): ?>
															 ...
															 <?php $__currentLoopData = $data->license; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

														<div class="license-area">
															<span class="remove license-remove"><i class="fas fa-times"></i></span>
																<div  class="row">
																   <div class="col-lg-6">
																	  <input type="text" name="license[]" class="input-field" placeholder="<?php echo e(__("License Key")); ?>" required="" value="<?php echo e($data->license[$key]); ?>">
																	</div>
																	<div class="col-lg-6">
																	   <input type="number" min="1" name="license_qty[]" class="input-field" placeholder="<?php echo e(__("License Quantity")); ?>" value="<?php echo e($data->license_qty[$key]); ?>">
																	</div>
															   </div>
														</div>
															...
															<span class="remove license-remove"><i class="fas fa-times"></i></span>
																<div  class="row">
																   <div class="col-lg-6">
																	...
																	<div class="col-lg-6">
																	   <input type="number" min="1" name="license_qty[]" class="input-field" placeholder="<?php echo e(__("License Quantity")); ?>">
																	</div>
															   </div>
														</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<div class="text-editor">
												<textarea name="details" class="nic-edit"><?php echo e($data->details); ?></textarea>
											</div>
										</div>
									</div>
									...
									<div class="<?php echo e(($data->meta_tag == null && strip_tags($data->meta_description) == null) ? "showbox":""); ?>">
									  ...
									  <div class="row">
										...
										<div class="col-lg-7">
											<input type="text" class="input-field" placeholder="<?php echo e(__("Enter Platform")); ?>" name="platform" value="<?php echo e($data->platform); ?>">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-7">
											<input type="text" class="input-field" placeholder="<?php echo e(__("Enter Region")); ?>" name="region" value="<?php echo e($data->region); ?>">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-7">
											<input type="text" class="input-field" placeholder="<?php echo e(__("Enter Type")); ?>" name="licence_type" value="<?php echo e($data->licence_type); ?>">
										</div>
									</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/product/edit/license.blade.php ENDPATH**/ ?>