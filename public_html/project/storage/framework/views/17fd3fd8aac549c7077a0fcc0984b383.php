...
<?php $__env->startSection('content'); ?>  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading"><?php echo e(__('Withdraw Earning')); ?></h4>
										<ul class="links">
											<li>
						...
						<form action="<?php echo e(route('admin-withdraw-income')); ?>" method="GET">
...
<script type="text/javascript">
	...
	$('.discount_date').val('');
	location.href = '<?php echo e(route('admin-withdraw-income')); ?>';
	})												
</script>
<?php $__env->stopSection(); ?>   
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/earning/withdraw_income.blade.php ENDPATH**/ ?>