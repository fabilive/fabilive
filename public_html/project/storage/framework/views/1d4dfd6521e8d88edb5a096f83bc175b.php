<?php $__env->startSection('content'); ?>
					<input type="hidden" id="headerdata" value="<?php echo e(__('LINK')); ?>">
...
(function($) {
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('vendor-sociallink-datatables')); ?>',
               columns: [
                        { data: 'link', name: 'link' },
        ...
        $(".btn-area").append('<div class="col-sm-4 mt-2 text-right">'+
        	'<a class="add-btn" href="<?php echo e(route('vendor-sociallink-create')); ?>">'+
          '<i class="fas fa-plus"></i> <?php echo e(__('Add New Link')); ?>'+
          '</a>'+
          '</div>');
	  });
...
<?php echo $__env->make('layouts.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/vendor/sociallink/index.blade.php ENDPATH**/ ?>