...
<?php $__env->startSection('content'); ?>
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading"><?php echo e(__('Digital Product')); ?> <a class="add-btn"
                                ...
                                <div class="product-description">
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="text-editor">
                                                    <select name="product_location" id="service_area_id"
                                        ...
                                        <div class="">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="left-area">
                                                        <h4 class="heading">
                                                            <?php echo e(__('Cross Showing Product By Current Category')); ?>*</h4>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/admin/product/create/digital.blade.php ENDPATH**/ ?>