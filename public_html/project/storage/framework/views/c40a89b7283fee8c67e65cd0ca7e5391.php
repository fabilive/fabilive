...
<div class="content-area">
	<div class="mr-breadcrumb">
		<div class="row">
			<div class="col-lg-12">
					<h4 class="heading"><?php echo e(__("Affiliate Product")); ?> <a class="add-btn" href="<?php echo e(route('vendor-import-index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__("Back")); ?></a></h4>
					<ul class="links">
						<li>
						...
						<li>
							<a href="<?php echo e(route('vendor-import-index')); ?>"><?php echo e(__("All Products")); ?></a>
						</li>
						<li>
							<a href="<?php echo e(route('vendor-import-create')); ?>"><?php echo e(__("Add Affiliate Product")); ?></a>
						</li>
					</ul>
			</div>
		</div>
	...
	<form id="geniusform" action="<?php echo e(route('vendor-import-store')); ?>" method="POST" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vendor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u112990875/domains/fabilive.com/public_html/project/resources/views/vendor/productimport/createone.blade.php ENDPATH**/ ?>