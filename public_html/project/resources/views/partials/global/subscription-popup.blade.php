...
<div class="subscribe-preloader-wrap" id="subscriptionForm">
    <div class="subscribePreloader__thumb" style="background-image: url({{asset('assets/images/'.$gs->popup_background)}});">
        ...
        <div class="subscribePreloader__text text-center">
            <h1>{{ __('NEWSLETTER') }}</h1>
            <p>{{ __('Hey there! Do you want to get updates on exclusive offers and good quality, affordable products at the best rates? To do so, just write your email address.') }}</p>
