    ...
    @endif
          ...
          <div class="col-lg-3 col-md-4">
             <div class="pro-details-sidebar-item mb-4">
                ...
                <!--        @if ($productt->user_id != 0 && isset($productt->user->country))-->
                <!--            {{ $productt->country->country_name }}-->
                <!--        @else-->
                <!--            {{ \App\Models\Admin::find(1)?->country?->country_name ?? 'N/A' }}-->
                <!--        @endif-->
                <!--    </p>-->
                
                <p>
    <strong>{{ __('Location:') }}</strong>
    @if ($productt->product_location != null)
        {{ $productt->cities->city_name }}
    @else
        {{ 'N/A' }}
    @endif
</p>
