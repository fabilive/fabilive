                                ...
                                <div class="body">
                                        <div class="edit-info-area-form">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="row pb-5">
                                                        <div class="col-lg-4 text-right pt-2 f-14">
                                                            <label>{{ __('Referral Banner *') }}</label>
                                                            <br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 text-right pt-2 f-14">
                                                            <label>{{ __('Referral Banner HTML Code *') }} <a id="affilate_html_click" data-toggle="tooltip" data-placement="top" title="Copy"  href="javascript:;" class="mybtn1 copy border px-3"><i class="fas fa-copy"></i></a></label>
                                                            <br>
