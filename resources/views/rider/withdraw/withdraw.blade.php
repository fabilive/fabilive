...
<div class="full-row">
   <div class="container">
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="widget border-0 p-40 widget_categories bg-light account-info">
                     ...
                     <form id="riderWithdrawForm" class="form-horizontal" action="{{ route('rider-wwt-store') }}" method="POST">
    @csrf
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-sm-12">{{ __('Select Saved Account') }}</label>
        <div class="col-sm-12">
