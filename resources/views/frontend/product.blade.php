                           ...
                           <div class="product-image">
                              <a href="{{ route('front.product', $prod['slug']) }}"
                                 class="woocommerce-LoopProduct-link"><img
                                    src="{{ $prod['thumbnail'] ? asset('assets/images/products/'.$prod['thumbnail'] ):asset('assets/images/noimage.png') }}"
                                    alt="Product Image"></a>
                        ...
                        <div class="product-wrapper">
                           <div class="product-image">
                              <a href="{{ route('front.product', $item->slug) }}"
                                 class="woocommerce-LoopProduct-link"><img
                                    src="{{ $item->thumbnail ? asset('assets/images/products/'.$item->thumbnail):asset('assets/images/noimage.png')}}"
                                    alt="Product Image"></a>
