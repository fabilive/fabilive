		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li>
						<a href="{{ route('vendor-flash-products-index') }}">{{ __('Flash Products') }}</a>
					</li>
				</ul>
			</div>
		</div>
...
<script type="text/javascript">
	(function($) {
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('vendor-flash-products-datatables') }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('vendor-flash-products-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
