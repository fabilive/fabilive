										...
										<div class="product-description">
											<div class="body-area">
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<input name="previous_price" step="0.1" type="number" class="input-field" placeholder="{{ __('e.g 200') }}" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-12">
														<input name="price" type="number" class="input-field" placeholder="{{ __('e.g 190') }}" step="0.1" required="" min="0">
													</div>
												</div>
