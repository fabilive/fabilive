                                    ...
                                    <div class="body-area">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="left-area">
                                                    <h4 class="heading">
                                                        {{ __('Product Location') }}* <small> (Select city and
                                                            area)</small>
                                                    </h4>
                                                </div>
                                            </div>
                                                ...
                                                <div class="text-editor">
                                                    <select name="product_location" class="form-control"
                                                        ...
                                                        @foreach ($serviceAreas as $area)
                                                            <option value="{{ $area->id }}">{{ $area->location }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input name="previous_price" step="0.1" type="number"
                                                    class="input-field" placeholder="{{ __('e.g 1000') }}"
                                                    min="1000">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <input name="price" type="number" class="input-field"
                                                    placeholder="{{ __('e.g 1000') }}" step="0.1" required=""
                                                    min="1000">
                                            </div>
                                        </div>
