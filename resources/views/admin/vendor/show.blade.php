                                            ...
                                            <div class="row">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ asset($data->residence_permit) }}" target="_blank">View</a></td>
                                                        </tr>

                                                        
                                                        <!--<tr>-->
                                                        <!--    <th>{{ __("Business Registration Certificate") }}</th>-->
                                                        <!--    <td><a href="{{asset('assets/uploads/documents/'. $data->business_registration_certificate) }}" target="_blank">View</a></td>-->
                                                        <!--</tr>-->
                                                        <!--<tr>-->
                                                        <!--    <th>{{ __("Tax Payer Card Copy") }}</th>-->
                                                        <!--    <td><a href="{{asset('assets/uploads/documents/'. $data->taxpayer_card_copy) }}" target="_blank">View</a></td>-->
                                                        <!--</tr>-->
                                                        <!--<tr>-->
                                                        <!--    <th>{{ __("ID Card Copy") }}</th>-->
                                                        <!--    <td><a href="{{asset('assets/uploads/documents/'. $data->id_card_copy) }}" target="_blank">View</a></td>-->
                                                        <!--</tr>-->
                                                        <!--<tr>-->
                                                        <!--    <th>{{ __("Passport Copy") }}</th>-->
                                                        <!--    <td><a href="{{asset('assets/uploads/documents/'. $data->passport_copy) }}" target="_blank">View</a></td>-->
                                                        <!--</tr>-->
                                                        <!--<tr>-->
                                                        <!--    <th>{{ __("Driver License Copy") }}</th>-->
                                                        <!--    <td><a href="{{asset('assets/uploads/documents/'. $data->driver_license_copy) }}" target="_blank">View</a></td>-->
                                                        <!--</tr>-->
                                                        <!--<tr>-->
                                                        <!--    <th>{{ __("Residence Permit For Foreigners") }}</th>-->
                                                        <!--    <td><a href="{{asset('assets/uploads/documents/'. $data->residence_permit) }}" target="_blank">View</a></td>-->
                                                        <!--</tr>-->
