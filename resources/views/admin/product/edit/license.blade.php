								...
								<div class="product-description">
                                    ...
                                    <!--</div>-->
                                            ...
                                            <div class="col-lg-12">
                                                <select name="country_id" id="countrycode" class="form-control" required>
                                                    ...
                                                    @foreach($countries as $country)
                                                        <option value="{{ $country->id }}" data-href="{{ route('admin-state-load', $country->id) }}" {{ $data->country_id == $country->id ? 'selected' : '' }}>{{ $country->country_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <select name="state_id" id="statecode" class="form-control" {{ !$data->state_id ? 'disabled' : '' }} required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <select name="product_city" id="citycode" class="form-control" {{ !$data->product_city ? 'disabled' : '' }} required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <select name="product_servicearea" id="service_area_id" class="form-control" {{ !$data->product_servicearea ? 'disabled' : '' }} required>
                                                    <option value="">-- Select Service Area --</option>
                                                    @if($data->product_city)
                                                        @foreach(\App\Models\City::find($data->product_city)->service_areas as $area)
                                                            <option value="{{ $area->id }}" {{ $data->product_servicearea == $area->id ? 'selected' : '' }}>{{ $area->location }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
								...
								<div class="body-area">
									...
									<div class="row">
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<input name="price" type="number" class="input-field" placeholder="e.g 20" step="0.1" min="1000" value="{{round($data->vendorPrice() * $sign->value , 2)}}" required="">
											</div>
										</div>
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<input name="previous_price" step="0.1" type="number" class="input-field" placeholder="e.g 20" value="{{round($data->vendorPreviousPrice() * $sign->value , 2)}}" min="1000">
											</div>
										</div>
