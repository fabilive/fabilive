                                                                ...
                                                                <div class="col-lg-5">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox"
                                                                            ...
                                                                            @if (is_array($selectedAttrs) && array_key_exists($inName, $selectedAttrs))
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        @foreach ($subAttribute->attribute_options as $option)
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-5">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" id="{{ $inName }}{{$option->id}}" name="{{ $inName }}[]" value="{{$option->name}}" class="custom-control-input attr-checkbox"
                                                                            @if (is_array($selectedAttrs) && array_key_exists($inName, $selectedAttrs) && in_array($option->name, $selectedAttrs[$inName]['values'] ?? []))
                                                                                checked
                                                                                @php $checked = 1; @endphp
                                                                            @endif>
                                                                        <label class="custom-control-label" for="{{ $inName }}{{$option->id}}">{{ $option->name }}</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-7 {{ $subAttribute->price_status == 0 ? 'd-none' : '' }}">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-10">
                                                                            <div class="price-container">
                                                                                <span class="price-curr">{{ $sign->sign }}</span>
                                                                                <input type="text" class="input-field price-input" id="{{ $inName }}{{$option->id}}_price" data-name="{{ $inName }}_price[]" placeholder="0.00 (Additional Price)" value="{{ $checked ? round($selectedAttrs[$inName]['prices'][$i] * $sign->value, 2) : '' }}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                        ...
                                        @if (!empty($childAttributes))
                                            @foreach ($childAttributes as $childAttribute)
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        @php $i = 0; @endphp
                                                        @foreach ($childAttribute->attribute_options as $option)
                                                            @php
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="price" type="number" class="input-field" placeholder="e.g 20"
												step="0.1" min="1000" value="{{round($data->vendorPrice() * $sign->value , 2)}}"
												required="">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input name="previous_price" step="0.1" type="number" class="input-field"
												placeholder="e.g 20"
												value="{{round($data->vendorPreviousPrice() * $sign->value , 2)}}" min="1000">
										</div>
									</div>
