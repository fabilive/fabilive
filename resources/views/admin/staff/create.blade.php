											...
											<form id="geniusformdata" action="{{ route('admin-staff-store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-4 d-flex justify-content-between">
                                                        ...
                                                        <label class="switch">
                                                            <input type="checkbox" name="section[]" value="support_live_chats">
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 d-flex justify-content-between">
                                                        ...
                                                        <label class="switch">
                                                            <input type="checkbox" name="section[]" value="support_kb">
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-lg-4 d-flex justify-content-between">
                                                        ...
                                                        <label class="switch">
                                                            <input type="checkbox" name="section[]" value="support_bot_rules">
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4 d-flex justify-content-between">
                                                        ...
                                                        <label class="switch">
                                                            <input type="checkbox" name="section[]" value="support_ai_dashboard">
                                                            <span class="slider round"></span>
                                                        </label>
                                                    </div>
