...
@section('content')
            ...
            <div class="content-area">
                <div class="mr-breadcrumb">
                    <div class="row">
                      <div class="col-lg-12">
                          <h4 class="heading">{{ __('Add Agreement') }} <a class="add-btn" href="{{route('admin-agreement-index')}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                          <ul class="links">
                            <li>
                            ...
                            <li>
                              <a href="{{ route('admin-agreement-create') }}">{{ __('Add Agreemnet') }}</a>
                            </li>
                          </ul>
                      </div>
                    </div>
                      ...
                      <div class="col-lg-12">
                        <div class="product-description">
                          <div class="body-area">
                            ...
                            <form id="geniusform" action="{{route('admin-agreement-store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
