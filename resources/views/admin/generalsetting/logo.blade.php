              ...
              <div class="row justify-content-center">
                <div class="col-xl-4 col-md-6">
                    <div class="special-box bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform-header" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}   
                ...
                <div class="col-xl-4 col-md-6">
                  <div class="special-box  bg-gray">
                      ...
                      <form class="uplogo-form" id="geniusform-footer" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}   
              ...
              @include('alerts.admin.form-both')  
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="special-box  bg-gray">
                        ...
                        <form class="uplogo-form" id="geniusform-invoice" action="{{ route('admin-gs-update') }}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}   
