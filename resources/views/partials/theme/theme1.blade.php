                                ...
                                <div class="product-image" style="height:200px;overflow:hidden;">
                                    @php
                                        ...
                                        if($fcategory->image && file_exists(public_path('assets/images/categories/'.$fcategory->image))) {
                                            ...
                                            $patterns = [
                                                'building_materials_lifestyle.png',
                                                'general_market_lifestyle.png',
                                                'baby_kids_lifestyle.png',
                                                'health_lifestyle.png',
                                                'gaming_lifestyle.png',
                                                'solar_power_lifestyle.png',
                                                'beauty_personal_lifestyle.png',
                                                'transport_auto_lifestyle.png',
                                                'internet_tech_lifestyle.png',
