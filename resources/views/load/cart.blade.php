<div class="cart-popup">
    <ul class="cart_list product_list_widget ">
        ...
        <li class="mini-cart-item">
            ...
            <a href="{{ route('front.product', $product['item']['slug']) }}" class="product-image"><img  src="{{ $product['item']['photo'] }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Cart product"></a>
